...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://127.0.0.1:3500/auth/login",
            ...
            if (!err?.response) {
                ...
                setErrMsg('Missing Email or Password'); // Updated error message
            ...
            {success ? (
                ...
                <section className="sectionRegister">
                    ...
                    <form onSubmit={handleSubmit} className="formRegistry">
                        ...
                        <label style={{ color: "#fff" }} htmlFor="password" className="labelRegistry">Password:</label>
                        <input
                            className="inputRegistry"
                            type="password"
                            id="password"
                            onChange={(e) => setPassword(e.target.value)} // Updated to set password
                            value={password} // Updated to use password
                            required
                        />
                    ...
                    <p>
                        Need an Account?<br />
                        <span className="line">
                            <a className="aRegistry" href="/signup">Sign Up</a>
                        </span>
                    </p>
                </section>
            )}
